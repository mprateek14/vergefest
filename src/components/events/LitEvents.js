	...
	return (
		<div>
			...
			<div className="lievents">
				...
				<CardLeft
					header={LitList[0].header}
					description={LitList[0].description}
					imageUrl={LitList[0].imageUrl}
				/>
				<br />
				<CardLeft
					header={LitList[1].header}
					description={LitList[1].description}
					imageUrl={LitList[1].imageUrl}
				/>
			</div>
			<div>
				<Footer />
